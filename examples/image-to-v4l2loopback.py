...
if __name__=="__main__":
	...
	device = os.open(devName, os.O_WRONLY | os.O_SYNC)	  
	#device = open(devName, 'w')
	...
	buff0 = ConvertToYUYV(format.fmt.pix.sizeimage, format.fmt.pix.bytesperline, im0)
	im1 = np.zeros((height, width, 3))
	buff1 = ConvertToYUYV(format.fmt.pix.sizeimage, format.fmt.pix.bytesperline, im1)
	...
	while True:		
		...
		if i% 2 == 0:
			os.write(device, buff1)
		else:
			os.write(device, buff0)
